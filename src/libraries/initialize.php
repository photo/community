...
getRoute()->get('/documentation/faq/([a-zA-Z0-9-]+)', array('GeneralController', 'documentationFaq'));
...
getApi()->get('/documentation/faq/([a-zA-Z0-9-]+).json', array('ApiController', 'documentationFaq'), EpiApi::external);
