...
<ul class="media-grid">
  ...
  <li>
    <a href="/img/screenshots/web-manage.png" class="inherit screenshot-link">
      <img class="thumbnail" src="/img/screenshots/web-manage-thumb.png" alt="">
    </a>
  </li>
</ul>

<h2>OpenPhoto on the iPhone</h2>
<ul class="media-grid">
  <li>
...
<h2>OpenPhoto on mobile phones (mobile web)</h2>
<ul class="media-grid">
  <li>
